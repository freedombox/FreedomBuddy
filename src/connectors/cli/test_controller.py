...
class CliListener(unittest.TestCase):
    ...
    def test_get_hosting_services(self):
        ...
        self.assertEqual('{"services": {"freedombuddy": ["http://127.0.0.1"], "freedombuddy-update-timestamp": null}, "client": "'+self.keyid+'"}', self.cliListener.hosting("list", self.keyid))
    ...
    def test_get_consuming_services(self):
        ...
        self.assertEqual('{"services": {"freedombuddy": ["http://127.0.0.2"], "freedombuddy-update-timestamp": null}, "host": "'+self.keyid+'"}', self.cliListener.consuming("list", self.keyid))
    ...
    def test_add_hosting_client_service(self):
        ...
        self.cliListener.hosting("add", self.test_keyid, "freedombuddy")
        self.assertEqual('{"services": {"freedombuddy": [], "freedombuddy-update-timestamp": null}, "client": "'+self.test_keyid+'"}', self.cliListener.hosting("list", self.test_keyid))

    def test_add_hosting_service_locations(self):
        """Confirm location is added for service x client."""
        date_to_use = str(datetime.utcnow())
        self.cliListener.hosting("add", self.test_keyid, "freedombuddy", "http://127.0.0.1", date_to_use)
        ...
        self.assertEqual('{"client": "'+self.test_keyid+'", "locations": "'+date_to_use+'", "service": "freedombuddy-update-timestamp"}', self.cliListener.hosting("list", self.test_keyid, "freedombuddy-update-timestamp"))
    ...
    def test_add_consuming_client_service(self):
        """Confirm service is added for client."""
        self.cliListener.consuming("add", self.test_keyid, "freedombuddy")
        self.assertEqual('{"services": {"freedombuddy": [], "freedombuddy-update-timestamp": null}, "host": "'+self.test_keyid+'"}', self.cliListener.consuming("list", self.test_keyid))

    def test_add_consuming_service_locations(self):
        """Confirm location is added for service x client."""
        date_to_use = str(datetime.utcnow())
        self.cliListener.consuming("add", self.test_keyid, "freedombuddy", "http://127.0.0.1", date_to_use)
        ...
        self.assertEqual('{"host": "'+self.test_keyid+'", "locations": "'+date_to_use+'", "service": "freedombuddy-update-timestamp"}', self.cliListener.consuming("list", self.test_keyid, "freedombuddy-update-timestamp"))
    ...
    def test_remove_hosting_location(self):
        ...
        self.assertEqual('{"services": {"freedombuddy": [], "freedombuddy-update-timestamp": null}, "client": "'+self.keyid+'"}', self.cliListener.hosting("list", self.keyid))
    ...
    def test_remove_consuming_location(self):
        ...
        self.assertEqual('{"services": {"freedombuddy": [], "freedombuddy-update-timestamp": null}, "host": "'+self.keyid+'"}', self.cliListener.consuming("list", self.keyid))
